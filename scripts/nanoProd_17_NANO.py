...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('file:myNanoProdData2017_PAT.root'),
    secondaryFileNames = cms.untracked.vstring(),
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/user/jbechtel/gc_storage/MuTau_data_2017_CMSSW944/TauEmbedding_MuTau_data_2017_CMSSW944_Run2017B/1/merged_0.root_'),
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('myNanoProdData2017 nevts:1'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('myNanoProdData2017_NANO.root'),
