...
# with command line options: -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 106X_dataRun2_v37 --era Run2_2016 --filein file:test_16.root --fileout file:test_nano_16.root --python_filename=embedding_nanoAOD_16.py
