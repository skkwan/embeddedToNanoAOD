...
# with command line options: -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 106X_dataRun2_v37 --era Run2_2017 --filein file:test_17.root --fileout file:test_nano_17.root --python_filename=embedding_nanoAOD_17.py
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:test_nano_17.root'),
