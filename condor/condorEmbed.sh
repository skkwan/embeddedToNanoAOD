...
do
	...
	do
	    ...
	    # Make a subfile in the job directory

	    # Replace placeholder string (cmsconfigfile) with the unique .py in temp/

	    # The subfile calls a .sh in this directory, which just does cmsRun
